...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/gaojinhsu/PodTestLib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'gaojinhsu' => 'greysongjxu@tencent.com' }
  s.source           = { :git => 'https://github.com/gaojinhsu/PodTestLib.git', :tag => s.version.to_s }
